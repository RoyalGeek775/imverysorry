...
export default function App() {
  ...
  const startBgTransition = 2700;
  const endBgTransition = 4600;
  ...
  return (
    ...
    >
      ...
      <div className="h-[12500px] w-full pointer-events-none select-none absolute top-0 left-0" />
      ...
      <div className="fixed inset-0 w-full h-full flex flex-col items-center justify-center overflow-hidden pointer-events-none z-10">
        ...
        >
          <h1 style={{ fontFamily: "var(--font-handwritten), cursive" }} className="text-5xl md:text-6xl tracking-wide leading-relaxed text-[#FAF6F0]">
            Hey love,
          </h1>
          <p 
